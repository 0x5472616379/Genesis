...
public class DumbPathfinder
{
    ...
    public static Location Follow(Entity npc, Entity following)
    {
        ...
        int distance = TileControl.CalculateDistance(npc.Location, following);
        ...
        if (distance > 1.5)
        {
            ...
            var next = new Location(moveX, moveY, npc.Location.Z);

...
public class TeleportCommand : RSCommand
{
    ...
    private static readonly Dictionary<string, (int, int, int)> NamedLocations = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Air_rune_altar"] = (2845, 4832, 0),
        ["Mind_rune_altar"] = (2796, 4818, 0),
        ["Water_rune_altar"] = (2713, 4836, 0),
        ["Earth_rune_altar"] = (2660, 4839, 0),
        ["Fire_rune_altar"] = (2584, 4836, 0),
        ["Body_rune_altar"] = (2527, 4833, 0),
        ["Cosmic_rune_altar"] = (2162, 4833, 0),
        ["Chaos_rune_altar"] = (2269, 4843, 0),
        ["Nature_rune_altar"] = (2398, 4841, 0),
        ["Law_rune_altar"] = (2464, 4834, 0),
        ["Death_rune_altar"] = (2207, 4836, 0),
